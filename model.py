...
class LSTM_Model():
    ...
    def self_attention_2(self, inputs, name):
        ...
        share_param = True
        hidden_size = inputs.shape[-1].value  # D value - hidden size of the RNN layern
        if share_param:
        ...
        params = {'w_omega': w_omega,        # dense_attention_2 = Dense(attention_size, activation=None,kernel_initializer=init1,kernel_regularizer=tf.contrib.layers.l2_regularizer(0.001))
